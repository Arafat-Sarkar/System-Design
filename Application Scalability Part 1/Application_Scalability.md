...
Increase resources of a single server (CPU, RAM).
...
The advantages of vertical scaling include easy implementation, improved performance by upgrading a single server, simpler management, and no need for architectural changes or load balancing.

**Cons of Vertical Scaling:**
The disadvantages of vertical scaling include limited scalability due to hardware limits, higher costs, potential downtime during upgrades, and the risk of a single point of failure.
---
